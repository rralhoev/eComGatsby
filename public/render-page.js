...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "GatsbyImage": () => (/* binding */ P),
/* harmony export */   "MainImage": () => (/* binding */ C),
/* harmony export */   "Placeholder": () => (/* binding */ z),
/* harmony export */   "StaticImage": () => (/* binding */ B),
/* harmony export */   "generateImageData": () => (/* binding */ k),
/* harmony export */   "getImage": () => (/* binding */ N),
/* harmony export */   "getImageData": () => (/* binding */ I),
/* harmony export */   "getLowResolutionImageURL": () => (/* binding */ S),
/* harmony export */   "getSrc": () => (/* binding */ O),
/* harmony export */   "getSrcSet": () => (/* binding */ R),
/* harmony export */   "withArtDirection": () => (/* binding */ x)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
function E(e) {
  ...
  }), a = camelcase__WEBPACK_IMPORTED_MODULE_2___default()(a), i && n ? c({}, e, {
    formats: u,
    layout: a
  }) : (o.width && o.height && !l && (l = o.width / o.height), "fullWidth" === a ? (i = i || o.width || s[s.length - 1], n = n || Math.round(i / (l || 1.3333333333333333))) : (i || (i = n && l ? n * l : o.width ? o.width : n ? Math.round(n / 1.3333333333333333) : 800), l && !n ? n = Math.round(i / l) : l || (l = i / n)), c({}, e, {
    width: i,
    height: n,
    aspectRatio: l,
    layout: a,
...
function k(e) {
  ...
  r && (r.width || r.height) ? r.format || (r.format = y(h)) : r = {
    width: d,
    height: u,
    format: (null == (t = r) ? void 0 : t.format) || y(h) || "auto"
  };
  var k = new Set(e.formats);
  (0 === k.size || k.has("auto") || k.has("")) && (k.delete("auto"), k.delete(""), k.add(r.format)), k.has("jpg") && k.has("png") && (w.warn("[" + a + "] Specifying both 'jpg' and 'png' formats is not supported. Using 'auto' instead"), k.delete("jpg" === r.format ? "png" : "jpg"));
  ...
  var N = function (e) {
    ...
    if (u.length) throw new Error("Specified dimensions for images must be positive numbers (> 0). Problem dimensions you have are " + u.map(function (e) {
      return e.join(": ");
    }).join(", "));
    return "fixed" === r ? function (e) {
      ...
      if (r && n) {
        ...
        r = m.width, n = m.height, c = m.aspectRatio;
      }

      r ? n || (n = Math.round(r / c)) : r = n ? Math.round(n * c) : 800;
      var f,
          w,
          b = r;

      if (a.width < r || a.height < n) {
        var y = a.width < r ? "width" : "height";
        u.warn((0,common_tags__WEBPACK_IMPORTED_MODULE_1__.stripIndent)(g || (f = ["\n    The requested ", ' "', 'px" for the image ', " was larger than the actual image ", " of ", "px. If possible, replace the current image with a larger one."], w || (w = f.slice(0)), f.raw = w, g = f), y, "width" === y ? r : n, t, y, a[y])), "width" === y ? (r = a.width, n = Math.round(r / c)) : r = (n = a.height) * c;
      }
      ...
      return {
        ...
        aspectRatio: c,
        presentationWidth: b,
        presentationHeight: Math.round(b / c),
        unscaledWidth: r
      };
    }(e) : "constrained" === r ? j(e) : "fullWidth" === r ? j(c({
      breakpoints: d
  ...
  R || (R = function (e, t) {
  ...
  }(N.presentationWidth, o)), k.forEach(function (e) {
    var t = N.sizes.map(function (t) {
      var i = n(h, t, Math.round(t / N.aspectRatio), e, s, l);
    ...
    if ("jpg" === e || "png" === e || "auto" === e) {
      var i = t.find(function (e) {
        return e.width === N.unscaledWidth;
      }) || t[0];
      i && (O.fallback = {
        src: i.src,
        srcSet: b(t),
  ...
  switch (o) {
    case "fixed":
      I.width = N.presentationWidth, I.height = N.presentationHeight;
      break;

    case "fullWidth":
      I.width = 1, I.height = 1 / N.aspectRatio;
      break;

    case "constrained":
      I.width = e.width || N.presentationWidth || 1, I.height = (I.width || 1) / N.aspectRatio;
  }
...
function j(e) {
  ...
  if (i && r) {
    ...
    i = h.width, r = h.height, u = h.aspectRatio;
  }

  i = i && Math.min(i, a.width), r = r && Math.min(r, a.height), i || r || (r = (i = Math.min(800, a.width)) / u), i || (i = r * u);
  var g = i;
  return (a.width < i || a.height < r) && (i = a.width, r = a.height), i = Math.round(i), (null == l ? void 0 : l.length) > 0 ? (t = l.filter(function (e) {
    return e <= a.width;
  })).length < l.length && !t.includes(a.width) && t.push(a.width) : t = (t = c.map(function (e) {
    ...
    aspectRatio: u,
    presentationWidth: g,
    presentationHeight: Math.round(g / u),
    unscaledWidth: i
  };
}
...
var N = function (e) {
  ...
  return function (e) {
    ...
    O = function (e) {
  var t, a, i;
  return null == (t = N(e)) || null == (a = t.images) || null == (i = a.fallback) ? void 0 : i.src;
},
    R = function (e) {
  var t, a, i;
  return null == (t = N(e)) || null == (a = t.images) || null == (i = a.fallback) ? void 0 : i.srcSet;
};
...
function I(e) {
  var t = e.baseUrl,
      ...
      r = e.sourceHeight,
      n = e.pluginName,
      o = void 0 === n ? "useGatsbyImage" : n,
      s = e.formats,
      l = void 0 === s ? ["auto"] : s,
      d = e.breakpoints,
      u = void 0 === d ? f : d,
      g = e.options;
  return k(c({}, h(e, ["baseUrl", "urlBuilder", "sourceWidth", "sourceHeight", "pluginName", "formats", "breakpoints", "options"]), {
    pluginName: o,
    generateImageSource: function (e, t, i, r) {
      return {
        width: t,
        height: i,
        format: r,
...
var W,
  ...
  var a = t.src,
      ...
      s = t.shouldLoad,
      l = t.innerRef,
      d = h(t, ["src", "srcSet", "loading", "alt", "shouldLoad", "innerRef"]);
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", Object.assign({}, d, {
    decoding: "async",
    loading: r,
    src: s ? a : void 0,
    "data-src": s ? void 0 : a,
    ...
    T = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(function (t, a) {
  var i = t.fallback,
      r = t.sources,
      n = void 0 === r ? [] : r,
      o = t.shouldLoad,
      ...
      u = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(A, Object.assign({}, l, i, {
    sizes: d,
    shouldLoad: s,
    innerRef: a
  }));
...
}, T.displayName = "Picture", T.propTypes = {
  alt: prop_types__WEBPACK_IMPORTED_MODULE_3__.string.isRequired,
  shouldLoad: prop_types__WEBPACK_IMPORTED_MODULE_3__.bool,
...
var z = function (t) {
  var a = t.fallback,
      i = h(t, ["fallback"]);
  return a ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(T, Object.assign({}, i, {
    fallback: {
      src: a
    },
    "aria-hidden": !0,
...
z.displayName = "Placeholder", z.propTypes = {
  ...
  sources: null == (W = T.propTypes) ? void 0 : W.sources,
  alt: function (e, t, a) {
    return e[t] ? new Error("Invalid prop `" + t + "` supplied to `" + a + "`. Validation failed.") : null;
  }
};
var C = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(function (t, a) {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(T, Object.assign({
    ref: a
  }, t)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("noscript", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(T, Object.assign({}, t, {
    shouldLoad: !0
  }))));
});
C.displayName = "MainImage", C.propTypes = T.propTypes;
...
var L = function () {
  ...
  var i = t.layout,
      ...
      o = t.children,
      s = null;
  return "fullWidth" === i && (s = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    "aria-hidden": !0,
    style: {
      paddingTop: n / r * 100 + "%"
    }
  })), "constrained" === i && (s = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    style: {
      maxWidth: r,
      display: "block"
    }
    ...
    role: "presentation",
    "aria-hidden": "true",
    src: "data:image/svg+xml;charset=utf-8,%3Csvg height='" + n + "' width='" + r + "' xmlns='http://www.w3.org/2000/svg' version='1.1'%3E%3C/svg%3E",
    style: {
      maxWidth: "100%",
      display: "block",
      position: "static"
    }
  }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, s, o, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(L, null));
},
    D = function (e) {
  return e.replace(/\n/g, "");
},
  ...
  var v = o.width,
    ...
    return global.GATSBY___IMAGE || (i.position = "relative", i.overflow = "hidden"), "fixed" === a ? (i.width = e, i.height = t) : "constrained" === a && (global.GATSBY___IMAGE || (i.display = "inline-block"), r = "gatsby-image-wrapper gatsby-image-wrapper-constrained"), {
      className: r,
      ...
      M = k.style,
      j = k.className,
      _ = h(k, ["style", "className"]),
      N = {
    fallback: void 0,
    sources: []
  };

  return y.fallback && (N.fallback = c({}, y.fallback, {
    srcSet: y.fallback.srcSet ? D(y.fallback.srcSet) : void 0
  })), y.sources && (N.sources = y.sources.map(function (e) {
    return c({}, e, {
      srcSet: D(e.srcSet)
    });
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(G, Object.assign({}, _, {
    as: a,
    style: c({}, M, n, {
      backgroundColor: g
    }),
    ...
    width: v,
    height: w
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(z, Object.assign({}, function (e, t, a, i, r, n) {
    var o = {};
  ...
  }(E, 0, b, v, w, S))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(C, Object.assign({
    "data-gatsby-image-ssr": "",
    className: d
  }, f, function (e, t, a, i, r, n, o, s) {
    return void 0 === s && (s = {}), global.GATSBY___IMAGE || (s = c({
      height: "100%",
      left: 0,
      position: "absolute",
      top: 0,
  ...
  layout: function (e) {
    if (void 0 !== e.layout && !F.has(e.layout)) return new Error("Invalid value " + e.layout + '" provided for prop "layout". Defaulting to "constrained". Valid values are "fixed", "fullWidth" or "constrained".');
  }
};

B.displayName = "StaticImage", B.propTypes = V;
...
/***/ "react-dom/server":
/*!*******************************************************************************!*\
  !*** external "/Users/a18574450/eComGatsby/node_modules/react-dom/server.js" ***!
  \*******************************************************************************/
/***/ ((module) => {

"use strict";
module.exports = require("/Users/a18574450/eComGatsby/node_modules/react-dom/server.js");;

/***/ }),

/***/ "react":
/*!**************************************************************************!*\
  !*** external "/Users/a18574450/eComGatsby/node_modules/react/index.js" ***!
  \**************************************************************************/
/***/ ((module) => {

"use strict";
module.exports = require("/Users/a18574450/eComGatsby/node_modules/react/index.js");;
